...
class TestDubwebDB(unittest.TestCase):
    ...
    def test_get_team_items(self):
        ...
        all_teams = admindb.get_team_items(
                                         all_providers_projects_teams,
                                         name_filter=None)
    ...
    def test_insert_delete_team_items(self):
        ...
        new_item = admindb.insert_team_item(
                                         new_team_id,
        ...
        self.assertEqual(len(item), 2)
        test_team = admindb.get_team_items(
                                 delete_team_id,
    ...
    def test_get_project_items(self):
        ...
        all_providers_projects_teams = admindb.AdmIDs(
                                         ...
                                         project_id=None,
                                         budget_id=None)
        all_projects = admindb.get_project_items(
                                         all_providers_projects_teams,
                                         name_filter=None,
                                         extid_filter=None)
    ...
    def test_edit_project_items(self):
        ...
        project_list = admindb.get_project_items(
                                         project_id_one,
                                         name_filter=None,
                                         extid_filter=None)
        ...
        test_projects = admindb.get_project_items(
                                 test_project_id,
                                 name_filter=None, extid_filter=None)
    ...
    def test_insert_delete_project_items(self):
        ...
        new_project_id = admindb.AdmIDs(prvid_test, teamid_test,
                                        project_id=None, budget_id=None)
        new_item = admindb.insert_project_item(
                                         new_project_id,
        ...
        item = admindb.delete_project_item(delete_project_id,
                                           ...
                                           my_extid=extid_test)
        self.assertEqual(len(item), 5)
        test_project = admindb.get_project_items(
                                 delete_project_id,
                                 name_filter=None, extid_filter=None)
        null_list = []
